...
mod d3dapp_hello_triange {
    ...
    impl D3DApp for D3DSample {
        ...
        fn bind_to_window(&mut self, hwnd: &HWND) -> Result<()> {
            ...
            let rtv_handle = unsafe { rtv_heap.GetGPUDescriptorHandleForHeapStart() };
    ...
    fn populate_command_list(resources: &Resources) -> Result<()> {
        ...
        let rtv_handle = D3D12_CPU_DESCRIPTOR_HANDLE {
            ptr: unsafe { resources.rtv_heap.GetGPUDescriptorHandleForHeapStart() }.ptr
        ...
        unsafe {
            command_list.ClearRenderTargetView(
                rtv_handle,
                &[0.0_f32, 0.2_f32, 0.0_f32, 1.0_f32],
                None,
            );
